...
public class POOBkemonException extends Exception {
    ...
    public static final String NULL_TEAM = "El equipo (Team) no puede ser nulo.";
    public static final String NULL_BAGPACK = "La mochila (BagPack) no puede ser nula.";
    public static final String EMPTY_TEAM = "El equipo no contiene pokémones.";
    public static final String NULL_POKEMON = "El pokémon en el equipo es nulo.";
    public static final String INVALID_FIRST_POKEMON = "El primer pokémon del equipo no es válido.";
